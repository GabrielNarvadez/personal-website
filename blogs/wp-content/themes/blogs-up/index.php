  ...
  <div class="grid-container">
    <div class="grid-x grid-margin-x align-center ">
      <div class="cell  small-24 <?php echo silkblog_sidebar_layout(); ?> large-order-2 ">
        <?php $blogpost_style = get_theme_mod('layout_page_post', 'layout2'); ?>
        <div class="blog-container <?php if ('layout2' == $blogpost_style) : ?> post-wrap-layout-2 grid-x grid-padding-x grid-padding-y <?php endif; ?>">
          <?php if (have_posts()) : ?>
            ...
            <?php while (have_posts()) : the_post(); ?>
               ...
               */
              $blogpost_style = get_theme_mod('layout_page_post', 'layout2');
              get_template_part('template-parts/layouts/part', '' . $blogpost_style . '', get_post_format());
              ?>
            <?php endwhile; ?>
