...
?>
        ...
        <!-- Projects End -->
                    ...
                    <div class="col-lg-4 offset-lg-8 padding-less img order-1" style="background-image:url('images/testi.jpg') jarallax" data-jarallax data-speed="0.5"></div><!-- end col -->    
                </div><!--end row-->
            </div><!--end container fluid-->
        </section><!--end section-->  
        <!-- Testimonial End -->
            ...
            <div class="container-fluid mt-100 mt-60">
                <div class="rounded-pill py-5 jarallax" data-jarallax data-speed="0.5" style="background: url('images/hireme.jpg') center center;">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 text-center">
